...
//Handles the resizing of three panels, Projects, Files, and Chat
export default function PanelManager() {
    function resizeLeftStart() {
        //changeLeftPanelWidth(e.clientX+'px')
        changeOverLeft(true)
    }
    ...
    //Note : Variables only used in local build, can easily be hard-coded in final build
